      ...
      <nav className="px-4 py-4">
        <ul className="space-y-2">
          {menuItems.map(item => <li key={item.href}>
              <Link to={item.href} className={`flex items-center p-2 rounded-lg ${activeItem === item.href ? "bg-gray-100 dark:bg-gray-700 text-blue-600 dark:text-blue-400" : "text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"}`} onClick={() => setActiveItem(item.href)}>
